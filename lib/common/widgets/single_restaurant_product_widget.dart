...
class ProductViewWidget extends StatelessWidget {
  ...
  const ProductViewWidget({super.key, required this.restaurants, required this.products, required this.isRestaurant, this.isScrollable = false,
    ...
    this.isCampaign = false, this.inRestaurantPage = false, this.showTheme1Restaurant = false, this.isWebRestaurant = false, this.isTitle = false, this.isRestaurantCategoryProducts = false});
