...
import 'hover_widgets/hover_zoom_widget.dart';
...
class ProductWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
                      ...
                      Row(children: [
                        Expanded(
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                            ...
                            !isRestaurant ? Row(children: [
                              RatingBarWidget(
                                rating: product!.avgRating!.toDouble(),  // Convert double? to int?
                          ...
                          !isRestaurant ? GetBuilder<CartController>(
                              builder: (cartController) {
                                ...
                                CustomButtonWidget(
                                  ...
                                  isBold: false,
                                  transparent: true,
                                  onPressed: () => Get.find<ProductController>().productDirectlyAddToCart(product, context),
    ...
    //   padding: EdgeInsets.only(bottom: desktop ? 10 :10),
    //   child: Container(
    //     margin: desktop ? null : const EdgeInsets.only(bottom: 0), decoration: BoxDecoration(
    ...
    //                         : baseUrls!.productImageUrl}'
    //                         '/${isRestaurant ? restaurant!.logo : product!.image}',
    //                     height: desktop ? 120 : length == null ? 100 : 75, width: desktop ? 120 : 80, fit: BoxFit.cover,
    //                   ),
    //                 ),
    //                 DiscountTagWidget(
    //                   discount: discount, discountType: discountType,
