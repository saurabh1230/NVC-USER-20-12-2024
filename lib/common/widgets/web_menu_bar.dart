...
import 'package:non_veg_city/common/widgets/hover_widgets/text_hover_widget.dart';
                ...
                child: SizedBox(
                  ...
                  child: Row(
                    children: [
                      InkWell(
                        onTap: () {
                          updateMetaTitle('Non Veg City - Best The Paradise of Non Veg');
                      ...
                      Expanded(
                        child: CustomSearchFieldWidget(
                          ...
                          iconPressed: () => Get.toNamed(RouteHelper.getCategoryRoute()),
                        ),
