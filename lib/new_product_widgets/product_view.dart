...
import 'package:non_veg_city/common/widgets/home_product_widget.dart';
...
import 'package:non_veg_city/common/widgets/product_widget.dart';
...
class ProductView extends StatelessWidget {
  ...
  const ProductView({super.key, required this.restaurants, required this.products, required this.isRestaurant, this.isScrollable = false,
    this.shimmerLength = 20, this.padding = const EdgeInsets.all(Dimensions.paddingSizeSmall), this.noDataText,
    this.isCampaign = false, this.inRestaurantPage = false, this.showTheme1Restaurant = false, this.isWebRestaurant = false, this.isTitle = false, this.isRestaurantCategoryProducts = false, this.restaurant});
