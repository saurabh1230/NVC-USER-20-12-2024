import 'package:non_veg_city/common/widgets/web_search_field_widget.dart';
...
import 'package:non_veg_city/features/chat/controllers/chat_controller.dart';
import 'package:non_veg_city/features/chat/domain/models/conversation_model.dart';
import 'package:non_veg_city/features/chat/widgets/chatting_shimmer_widget.dart';
import 'package:non_veg_city/features/chat/widgets/message_bubble_widget.dart';
import 'package:non_veg_city/features/chat/widgets/web_conversation_list_view_widget.dart';
import 'package:non_veg_city/common/enums/user_type.dart';
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        && widget.chatController.conversationModel!.conversations!.isNotEmpty) ? Center(child: SizedBox(width: Dimensions.webMaxWidth, child: WebSearchFieldWidget(
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: Column(children: [
                        ...
                        ) : Center(child: Text('no_message_found'.tr)) : const ChattingShimmerWidget() :  Center(child: Text('no_conversation_selected'.tr))),
