...
import 'package:non_veg_city/features/cart/widgets/cart_product_widget.dart';
import 'package:non_veg_city/features/cart/widgets/cart_suggested_item_view_widget.dart';
import 'package:non_veg_city/features/cart/widgets/checkout_button_widget.dart';
import 'package:non_veg_city/features/cart/widgets/pricing_view_widget.dart';
...
import 'package:non_veg_city/common/widgets/web_constrained_box.dart';
        ...
        return GetBuilder<CartController>(builder: (cartController) {
          ...
          return (cartController.isLoading && widget.fromReorder) ? const Center(
            ...
            children: [
                        ...
                        child: SizedBox(
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              isDesktop ? Expanded(flex: 4, child: PricingViewWidget(cartController: cartController)) : const SizedBox(),
              ...
              isDesktop ? const SizedBox.shrink() : CheckoutButtonWidget(cartController: cartController, availableList: cartController.availableList),

            ],
          ) : const SingleChildScrollView(child: FooterViewWidget(child: NoDataScreen(isCart: true, title: '')));
        },
        );
      }),
    );
