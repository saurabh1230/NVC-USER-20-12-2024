...
import 'package:non_veg_city/features/business/widgets/payment_cart_widget.dart';
...
import 'package:non_veg_city/features/business/controllers/business_controller.dart';
import 'package:non_veg_city/features/business/domain/models/package_model.dart';
import 'package:non_veg_city/features/business/widgets/base_card_widget.dart';
import 'package:non_veg_city/features/business/widgets/business_payment_method_bottom_sheet_widget.dart';
import 'package:non_veg_city/features/business/widgets/subscription_card_widget.dart';
import 'package:non_veg_city/features/business/widgets/success_widget.dart';
import 'package:non_veg_city/helper/color_coverter.dart';
    ...
    return GetBuilder<BusinessController>(
      builder: (businessController) {
        return PopScope(
          ...
          child: Scaffold(
            appBar: CustomAppBarWidget(title: 'business_plan'.tr, isBackButtonExist: false),
                              ...
                              businessController.packageModel != null ? SizedBox(
                                ...
                                child: (businessController.packageModel!.packages!.isNotEmpty && businessController.packageModel!.packages!.isNotEmpty) ? Swiper(
                                  ...
                                  itemBuilder: (BuildContext context, int index){
                                    ...
                                    children: [
                                      Image.asset(Images.emptyFood, height: 150),
