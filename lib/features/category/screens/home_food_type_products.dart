...
class HomeFoodTypeProducts extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    int displayLength =
        length > 6 ? 6 : length; // Limit the number of items to 6
                ...
                : ResponsiveHelper.isTab(context)
                    ...
                    : isCooked
                        ? Expanded(
                            child: CustomInkWellWidget(
                              onTap: () => Get.toNamed(RouteHelper
                                  .getCookedUnCookedCategoryProductRoute(
                                1,
                                "cooked",
                              )),
                              child: Container(
                        ...
                        : Expanded(
                            child: CustomInkWellWidget(
                              onTap: () => Get.toNamed(
                                  RouteHelper.getUnCookedCategoryProductRoute(
                                1,
                                "uncooked",
                              )),
                              child: Container(
