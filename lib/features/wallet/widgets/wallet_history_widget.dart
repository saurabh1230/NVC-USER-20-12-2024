...
import 'package:non_veg_city/features/wallet/widgets/history_cart_widget.dart';
    ...
    return GetBuilder<WalletController>(
      builder: (walletController) {
        ...
        return Column(children: [
          ...
          ) : NoDataScreen(title: 'no_data_found'.tr) : WalletShimmer(walletController: walletController),
