...
class MobilePopularRestaurantsViewWidget extends StatelessWidget {
  final bool isRecentlyViewed;
  const MobilePopularRestaurantsViewWidget({super.key, this.isRecentlyViewed = false});
                    ...
                    child: Container(
                      ...
                      child:CustomInkWellWidget(
                        onTap: () {
                          ...
                          Get.toNamed(
                            RouteHelper.getRestaurantRoute(slug, restaurant.id!), // Pass slug and id
