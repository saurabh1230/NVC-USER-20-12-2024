...
class CategoryHomeViewWidget extends StatelessWidget {
  ...
  const CategoryHomeViewWidget({super.key, required this.restaurants, required this.products, required this.isRestaurant, this.isScrollable = false,
