        ...
        return (restaurantList != null && restaurantList.isEmpty) ? const SizedBox() : Padding(
          ...
          child: SizedBox(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ResponsiveHelper.isDesktop(context) ? Padding(
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    Text(isRecentlyViewed ? 'your_restaurants'.tr : 'popular_restaurants'.tr,
                      style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge, fontWeight: FontWeight.w600,color: Theme.of(context).primaryColor),
                    ),
              ...
              RestaurantsViewWidget(restaurants: restaurantList,isPopular: true,),
              ...
              //                 onTap: () {
              //                   ResponsiveHelper.isMobile(context) ? Get.toNamed(RouteHelper.getRestaurantRoute(restaurantList[index].id), arguments: RestaurantScreen(restaurant:  restaurantList[index])):
              //                   Get.toNamed(RouteHelper.getRestaurantWebRoute(restaurantList[index].id), arguments: RestaurantScreenWeb(restaurant:  restaurantList[index]));
              //                 },
              //
              //                   //   Get.toNamed(RouteHelper.getRestaurantRoute(restaurantList[index].id),
              ...
              //                                 isWished ? favouriteController.removeFromFavouriteList(restaurantList[index].id, true)
              //                                     : favouriteController.addToFavouriteList(null, restaurantList[index], true);
              //                               }else {
