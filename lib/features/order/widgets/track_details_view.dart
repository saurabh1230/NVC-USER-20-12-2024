...
import 'package:non_veg_city/features/order/widgets/address_details_widget.dart';
import 'package:non_veg_city/common/widgets/custom_divider_widget.dart';
    ...
    return Container(
      ...
      child: (!takeAway && track.deliveryMan == null) ? Padding(
        ...
        Row(children: [
          ...
          SizedBox(width: 80, child: CustomDividerWidget(color: Theme.of(context).primaryColor, height: 2)),
          ...
          Expanded(
              flex: 5,
              child: takeAway ? Text(track.restaurant != null ? track.restaurant!.address! : '', style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall),
        ...
        Row(children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            RatingBarWidget(
              rating: takeAway ? track.restaurant != null ? track.restaurant!.avgRating : 0 : track.deliveryMan!.avgRating, size: 10,
