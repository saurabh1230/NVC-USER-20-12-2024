...
import 'package:non_veg_city/features/order/widgets/guest_custom_stepper.dart';
import 'package:non_veg_city/features/order/widgets/traking_map_widget.dart';
                      ...
                      child: orderController.trackModel != null ? Column(children: [
                        ...
                        Column(children: [
                          ...
                          GuestCustomStepper(
                            ...
                            trailing: (orderController.trackModel?.deliveryMan?.phone != null && status != AppConstants.delivered && status != AppConstants.refundRequested)
                                ? InkWell(
                              onTap: () async {
