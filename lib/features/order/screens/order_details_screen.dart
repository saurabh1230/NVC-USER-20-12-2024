import 'package:non_veg_city/features/checkout/widgets/offline_success_dialog.dart';
import 'package:non_veg_city/features/order/controllers/order_controller.dart';
import 'package:non_veg_city/features/order/domain/models/subscription_schedule_model.dart';
import 'package:non_veg_city/features/order/widgets/bottom_view_widget.dart';
import 'package:non_veg_city/features/order/widgets/order_info_section.dart';
import 'package:non_veg_city/features/order/widgets/order_pricing_section.dart';
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      child: GetBuilder<OrderController>(builder: (orderController) {
        ...
        return Scaffold(
            appBar: CustomAppBarWidget(title: subscription ? 'subscription_details'.tr : 'order_details'.tr, onBackPressed: () {
              if((widget.orderModel == null || widget.fromOfflinePayment) && !widget.fromGuestTrack) {
                Get.offAllNamed(RouteHelper.getInitialRoute());
              } else if(widget.fromGuestTrack){
                Get.back();
