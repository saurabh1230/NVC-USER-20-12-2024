...
class RestaurantsViewVerticalWidget extends StatelessWidget {
  final List<Restaurant?>? restaurants;
  final bool isCooked;
  const RestaurantsViewVerticalWidget({super.key, this.restaurants,  this.isCooked = false, });
          ...
          children: [
            ...
            Expanded(
              ...
              children: [
                ...
                Text( restaurant.address!, overflow: TextOverflow.ellipsis, maxLines: 3,
