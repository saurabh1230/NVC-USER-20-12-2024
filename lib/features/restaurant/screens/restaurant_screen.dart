...
import 'package:non_veg_city/features/restaurant/widgets/restaurant_info_section_widget.dart';
import 'package:non_veg_city/features/restaurant/widgets/restaurant_screen_shimmer_widget.dart';
...
class _RestaurantScreenState extends State<RestaurantScreen> {
  ...
  void initState() {
    super.initState();
    print('check id ======================================================>>${widget.restaurant!.id.toString()}');
      ...
      body: GetBuilder<RestaurantController>(builder: (restController) {
        return GetBuilder<CategoryController>(builder: (categoryController) {
          ...
          return (restController.restaurant != null && restController.restaurant!.name != null && categoryController.categoryList != null) ? CustomScrollView(
            ...
            slivers: [
              RestaurantInfoSectionWidget(restaurant: restaurant!, restController: restController),
