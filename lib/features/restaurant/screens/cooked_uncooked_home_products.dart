...
class HomeCookedUncookedProducts extends StatelessWidget {
  final List<Restaurant?>? restaurants;
  const HomeCookedUncookedProducts({super.key, this.restaurants});
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: restaurants != null ? restaurants!.isNotEmpty ? GridView.builder(
        shrinkWrap: true,
        itemCount: min(restaurants!.length, 8),
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        IconWithTextRowWidget(
                          icon: Icons.star_border, text: '5.0',
                          style: robotoBold.copyWith(fontSize: Dimensions.fontSizeExtraSmall),
                        ),
