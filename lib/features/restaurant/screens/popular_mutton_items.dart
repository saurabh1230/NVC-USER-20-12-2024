...
import 'package:non_veg_city/features/home/widgets/item_card_widget.dart';
...
class PopularMuttonItems extends StatefulWidget {
  final String? categoryID;
  final String categoryName;
  final String categoryBanner;
  final String heading;

  const PopularMuttonItems({
    super.key,
  ...
  @override
  State<PopularMuttonItems> createState() => _PopularMuttonItemsState();
}

class _PopularMuttonItemsState extends State<PopularMuttonItems> {

  @override
  void initState() {
    super.initState();
    Get.find<CategoryController>().getMuttonCategoryProductList("18",1, '',false);
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<CategoryController>(
      builder: (catController) {
        ...
        if(catController.muttonCategoryList != null && catController.searchProductList != null) {
          products = [];
          if (catController.isSearching) {
            products.addAll(catController.searchProductList!);
          } else {
            products.addAll(catController.muttonCategoryList!);
          }
        }
        ...
        return Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
            children: [
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Column(crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("Best Selling Mutton Items", style: robotoBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge,color: Colors.black.withOpacity(0.80))),
              ...
              // ),
              catController.muttonCategoryList !=null ? SizedBox(
