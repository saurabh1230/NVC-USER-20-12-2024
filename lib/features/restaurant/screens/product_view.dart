...
import 'package:non_veg_city/common/widgets/discount_tag_without_image_widget.dart';
...
import 'package:non_veg_city/common/widgets/quantity_button_widget.dart';
...
import 'package:non_veg_city/features/product/controllers/product_controller.dart';
import 'package:non_veg_city/helper/cart_helper.dart';
...
import 'package:non_veg_city/common/widgets/cart_snackbar_widget.dart';
...
import '../../../common/widgets/menu_drawer_widget.dart';
import '../../home/widgets/best_review_item_view_widget.dart';
...
class ProductViewScreen extends StatefulWidget {
  ...
  final bool? isActive;
  const ProductViewScreen({super.key, required this.product, this.isCampaign = false, this.cart, this.cartIndex, this.inRestaurantPage = false, this.isActive});
...
class _ProductViewScreenState extends State<ProductViewScreen> {
  ...
  void initState() {
    ...
    Get.find<ReviewController>().getReviewedProductList(true, 'all', false);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(appBar: WebMenuBar(),
        ...
        child: Padding(
          ...
          child: Column(
            children: [
                  ...
                  child: Column(
                    children: [
                      GetBuilder<ProductController>(builder: (productController) {
                        ...
                        double variationPrice = _getVariationPrice(widget.product!, productController);
                        ...
                        print('check bool ======>  ${widget.product!.price}');
                                                ...
                                                child: Stack(children: [
                                                  ClipRRect(
                                                    ...
                                                    child: CustomImageWidget(
                                                      ...
                                                      width: ResponsiveHelper.isMobile(context) ? 100 : 400,
                                                      height: ResponsiveHelper.isMobile(context) ? 100 : 400,
                                                      fit: BoxFit.cover,
                                                    ),
                                                  ),
                                              ...
                                              Flexible(
                                                child: Column(mainAxisAlignment: MainAxisAlignment.start,
                                                    crossAxisAlignment: CrossAxisAlignment.start, children: [
                                                      ...
                                                      RatingBarWidget(rating: widget.product!.avgRating, size: 20, ratingCount: widget.product!.ratingCount),
                                                      ...
                                                      Row(mainAxisAlignment: MainAxisAlignment.start,
                                                          children: [
                                                            ...
                                                            Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(Dimensions.radiusSmall,
                                                                  ...
                                                                  return Row(mainAxisAlignment: MainAxisAlignment.start,
                                                                    children: [
                                                                      CustomButtonWidget(
                                                                        ...
                                                                        width: ResponsiveHelper.isDesktop(context) ? 160: 120,
                                                                  ...
                                                                  child: Row(mainAxisAlignment: MainAxisAlignment.start,
                                                                    children: [
                                                                      CustomButtonWidget(
                                                                        ...
                                                                        height: 40,
                                                                        radius : Dimensions.radiusSmall,
                                                                        width: ResponsiveHelper.isDesktop(context) ? 170: 130,
                                                                        isLoading: cartController.isLoading,
                                                                        buttonText: (!widget.product!.scheduleOrder! && !isAvailable) ? 'not_available_now'.tr
                                                                            : widget.isCampaign ? 'order_now'.tr : (widget.cart != null || productController.cartIndex != -1) ? 'update_in_cart'.tr : 'add_to_cart'.tr,
                                                                        onPressed: (!widget.product!.scheduleOrder! && !isAvailable) ? null : () async {
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Row(
                                                          ...
                                                          PriceConverter.convertAnimationPrice(
                                                            ...
                                                            textStyle: robotoBold.copyWith(color: Theme.of(context).primaryColor,fontSize: Dimensions.fontSizeExtraLarge),
                                                          ),
                                                      ...
                                                      // Row(
                                                      //   children: [
                                                      //     Container(padding: EdgeInsets.symmetric(vertical: Dimensions.paddingSizeExtraSmall,horizontal: Dimensions.paddingSizeOverLarge),
                                                      //       decoration: BoxDecoration(borderRadius: BorderRadius.circular(Dimensions.radiusSmall), color: Theme.of(context).primaryColor.withOpacity(0.15)),
                                                      //       child: Row(
                                                      //         children: [
                                                      //           Icon(Icons.restaurant,color: Theme.of(context).primaryColor,),
                                                      //           SizedBox(width: Dimensions.paddingSizeExtraSmall,),
                                                      //           Text(widget.product!.food_type == 1 ? 'Cooked'.tr : 'UnCooked'.tr, style: robotoLight.copyWith(fontSize: Dimensions.fontSizeDefault,color: Theme.of(context).primaryColor)),
                                                      //
                                                      //         ],
                                                      //       ),
                                                      ...
                                                      //           SizedBox(width: Dimensions.paddingSizeSmall,),
                                                      //           Text(widget.product!.ratingCount.toString() , style: robotoLight.copyWith(fontSize: Dimensions.fontSizeDefault,color: Theme.of(context).primaryColor)),
                                                      //
                                                      //         ],
                                                      //       ),
                                                      //     ),SizedBox(width: Dimensions.paddingSizeSmall,),
                                                      ...
                                                      //           SizedBox(width: Dimensions.paddingSizeExtraSmall,),
                                                      //           Text(discount! > 0 ? '${(isRightSide || discountType == 'percent') ? '' : currencySymbol}$discount${discountType == 'percent' ? '%'
                                                      //               : isRightSide ? currencySymbol : ''} ${'off'.tr}' : 'free_delivery'.tr, style: robotoLight.copyWith(fontSize: Dimensions.fontSizeDefault,color: Theme.of(context).primaryColor)),
                                                      //
                                                      //         ],
                                                      //       ),
                                                      //     ),
                                                  ...
                                                  return InkWell(
                                                    onTap: () {
                                                      if(Get.find<AuthController>().isLoggedIn()) {
                                                        favouriteController.wishProductIdList.contains(widget.product!.id) ? favouriteController.removeFromFavouriteList(widget.product!.id, false)
                                                    ...
                                                    child: Container(
                                                      ...
                                                      padding: const EdgeInsets.all(Dimensions.paddingSizeSmall),
                                                      child: Icon(
                                                        favouriteController.wishProductIdList.contains(widget.product!.id) ? Icons.favorite : Icons.favorite_border,
                                                        color: favouriteController.wishProductIdList.contains(widget.product!.id) ? Theme.of(context).primaryColor
                                                            : Theme.of(context).disabledColor,
                                                      ),
                                                    ),
                                                  );
                                                }),
                                                SizedBox(height: Get.find<SplashController>().configModel!.toggle_cooked_uncooked! ? 50 : 0),
                                            ...
                                            return Container(
                                              ...
                                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                                ...
                                                ListView.builder(
                                                  ...
                                                  itemCount: productController.collapseVariation[index] ? widget.product!.variations![index].variationValues!.length > 4
              ...
              FooterViewWidget(child:   _configModel!.popularFood == 1 ?   BestReviewItemViewWidget(isPopular: false) : const SizedBox(),)
            ],
          ),
        ),
      ),
  ...
  Future<OnlineCart> _processOnlineCart(ProductController productController, CartController cartController, List<AddOn> addOnIdList, List<AddOns> addOnsList, double priceWithAddonsVariation) async {
    ...
    OnlineCart onlineCart = OnlineCart(
        ...
        widget.isCampaign ? null : widget.product!.id, widget.isCampaign ? widget.product!.id : null,
